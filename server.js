...
app.listen(PORT, () => {
    console.log(
        `Spare Part USSD Service : Running in ${process.env.NODE_ENV} mode and listening on port http://:${PORT}`
    );
    logger.debug(`Spare Part USSD Service: Running in ${process.env.NODE_ENV} mode and listening on port http://:${PORT}`);
});
